...
#### TOC
- [4.1 AWS 요금 모델 비교](#41-aws-요금-모델-비교)

- [4.2 결제, 예산 및 비용 관리를 위한 리소스 이해](#42-결제-예산-및-비용-관리를-위한-리소스-이해)

- [4.3 AWS 기술 리소스 및 AWS Support 옵션 파악](#43-aws-기술-리소스-및-aws-support-옵션-파악)
